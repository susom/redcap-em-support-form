...
$token = $module->getSystemSetting('krb5-api-token')?:'';
$ldap = file_get_contents('http://127.0.0.1:8080/webtools/redcap-ldap/redcap_validator_web_service.php?token='.$token.'&exact=true&only=displayname,sudisplaynamefirst,sudisplaynamelast,sudisplaynamelf,mail,telephonenumber,suaffiliation,sugwaffiliation1,ou,telephonenumber,suprimaryorganizationid,susunetid&username=' . $sunetid);
