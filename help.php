...
// Do LDAP Lookup
$ldap = file_get_contents('http://med.stanford.edu/webtools-dev/stanford_ldap/ldap_lookup.php?token=REDACTED_LDAP_TOKEN&exact=true&only=name,displayname,mail,department,suaffiliation,ou,telephonenumber&userid='. $sunetid);
